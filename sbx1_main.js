(() => {
  ...
  function spawn_pe() {
    ...
    if (integrated) {
      ...
      let validTweaks = { fiveicon: 1, powercuff: 1, mgpatcher: 1, applimit: 1, callrec: 1 };
      let lsTweakSet = {};
      ...
      if (!lsTweakSet.fiveicon && !lsTweakSet.powercuff && !lsTweakSet.mgpatcher && !lsTweakSet.applimit && !lsTweakSet.callrec) lsTweakSet.fiveicon = true; // safe default
      ...
      if (lsTweakSet.callrec) lsTweaksOut.push('callrec');
      ...
      prelude += 'globalThis.__ls_enable_callrec = ' + (lsTweakSet.callrec ? 'true' : 'false') + ';\n';
      let callrecDurRaw = Number(globalThis.__callrec_duration);
      let callrecDuration = (isFinite(callrecDurRaw) && callrecDurRaw >= 10 && callrecDurRaw <= 600) ? Math.floor(callrecDurRaw) : 60;
      prelude += 'globalThis.__callrec_duration = ' + callrecDuration + ';\n';
      ...
      addTweakPrefetch(lsTweakSet.callrec, 'call_recorder_katana.js', '__callrec_code', 'CallRecorder');
